    ...
    <div class="col-3">
        ...
        @endphp
            ...
            <form class="form w-100" action="/users/kintai/{{Auth::id()}}" method="get">
                ...
                <div class="d-grid text-center">
                    <button class="btn btn-secondary btn-sm w-75" type="submit">表示更新</button>
                </div>
            </form>
        ...
        <form class="form mt-5 w-100" method="POST" action="/users/update/{{ $item->id }}">
            ...
            <table class="table">
                <tr>
                    <th>氏名</th>
                    <td><input type="text" value="{{$item->name}}" name="name" class="form-control" readonly></td>
                </tr>
                <tr>
                    <th>職番</th>
                    <td><input type="number" value="{{$item->employee_num}}" name="employee_num" class="form-control" readonly></td>
                </tr>
                <tr>
                    <th>日付</th>
                    <td><input type="date" value="{{$atdate}}" max="{{date("Y-m-d")}}" name="date" class="form-control"></td>
                </tr>
                <tr>
                    <th>出勤時間</th>
                    <td>
            ...
            <div class="d-grid text-center">
                <button type="submit" class="btn btn-success btn-lg w-75">登録する</button>
            </div>
        </form>
    </div>
    <div class="col-3">
